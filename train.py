#modified version of https://github.com/dusty-nv/pytorch-classification/blob/master/train.py
import argparse
import os
import random
import shutil
...
parser.add_argument('--model-dir', type=str, default='models/traffic_signs')
parser.add_argument('-a', '--arch', metavar='ARCH', default='resnet18',
                    choices=model_names,
                    help='model architecture: ' +
                        ' | '.join(model_names) +
                        ' (default: resnet18)')
parser.add_argument('--resolution', default=256, type=int, metavar='N')
...
parser.add_argument('--dist-url', default='tcp://192.168.4.227:23456', type=str,
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    # data loading code
    traindir = os.path.join('data/traffic_signs', 'train')
    valdir = os.path.join('data/traffic_signs', 'val')
